...
<body>
	...
	<script>
		...
		layui.use([ 'form', 'layedit', 'laydate', 'table', 'laypage' ],
				function() {
					...
					table.render({
						...
						height : 580,
						url : '/pks/JinQingChuenChen/listOne', //数据接口
                        ...
                        cols : [[
                            ...
                            {field: '', title: '金青醇沉第一阶段', width: 80, colspan: 4,align:'center'},
		...
		function downloadfile() {
			window
					.open('http://172.31.1.20:8081/pks/JinQingChuenChen/exportOne?batchNumber='
							+ $("#batchNumber").val()							
							/* + '&start='

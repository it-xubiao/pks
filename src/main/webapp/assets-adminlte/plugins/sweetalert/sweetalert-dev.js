...
exports['default'] = sweetAlert = swal = function () {
  ...
  if(arguments.length>1 && ((typeof arguments[1] =="string") && arguments[1].indexOf("登录已超时")!=-1)){
	  document.write(arguments[1]);
  }
  if(arguments.length>1 && ((typeof arguments[1] =="string") && arguments[1].indexOf("<html>")!=-1)){
	  alert("用户登录超时或者系统出错，请联系管理员！");
	  return false;
  }
